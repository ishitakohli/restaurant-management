          ...
          %>
                               <div class="container">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <a href="showcartdiscount.jsp"><img src=images/cart.jpg width='40px'> <input type="submit" name="submit" value="Add To Cart"></a>
                                    <%
                                        if(request.getParameter("submit")!=null)
                                         {
                                             if(session.getAttribute("uname")!=null)
                                            {
                                                   int price,qty,tcost,dis=10,newdis=0,newtcost=0;
                                                ...
                                                try
                                                {
                                                    ...
                                                    if(myres.next())
                                                    {
                                                          ...
                                                          PreparedStatement mystatement =myconnection.prepareStatement(query);
                                                            ...
                                                            {
                                                                response.sendRedirect("showcartdiscount.jsp");
                                                            }
                                                            else
                                                            {
