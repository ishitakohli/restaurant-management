...
if(mycookies!=null)
{
    ...
    for(Cookie mycookie:mycookies)
    {
      ...
      out.write("\t\t\t\t<form action=\"mylogin\" method=\"post\" id=\"loginform\"> \r\n");
      out.write("\t\t\t\t\t<input class=\"agile-ltext\" type=\"text\" name=\"username\" placeholder=\"Username\" required=\"\">\r\n");
      ...
      out.write("\t\t\t\t\t\t<ul> \r\n");
      out.write("\t\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<label class=\"checkbox\"><input type=\"checkbox\" name=\"checkbox\"><i></i> \r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span> Remember me ?</span> \r\n");
      out.write("\t\t\t\t\t\t\t\t</label> \r\n");
      out.write("\t\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\t<li><a href=\"forgotpass.jsp\">Forgot password?</a> </li>\r\n");
      out.write("\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"clearfix\"> </div>\r\n");
      out.write("\t\t\t\t\t</div>   \r\n");
      ...
      out.write("                                        </div> \r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t<p>Don't have an Account? <a href=\"signup.jsp\"> Sign Up Now!</a></p> \r\n");
      out.write("\t\t\t</div>\t \r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("        ");
